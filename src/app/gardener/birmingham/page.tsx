...
const content: LocalCityPageContent = {
  ...
  localContextHeading: "Garden work in Birmingham depends on access, planting and tree controls",
  ...
  areaIntro: "From established gardens around Harborne, Hall Green and Sutton Coldfield to tighter terraced plots and shared-access gardens elsewhere in Birmingham, the practical setup can vary sharply. Use the exact postcode and describe the access route so gardeners can judge whether the job fits their equipment and travel area.",
  areaNoteHeading: "Tell gardeners about gates, waste and protected trees",
  areaNote: "Give the approximate garden size, gate width or access route and say if tools or waste must pass through the house. If mature trees are part of the job, mention them separately and check protection status before asking for pruning or removal. Also be clear about whether cuttings and green waste should be removed from site.",
