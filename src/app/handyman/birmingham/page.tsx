...
const content: LocalCityPageContent = {
  ...
  localContextHeading: "What Birmingham’s housing mix can mean for handyman jobs",
  ...
  areaIntro: "Birmingham covers a wide spread of neighbourhoods, from Edgbaston and Harborne to Erdington, Hall Green, Yardley and Sutton Coldfield. Use the exact job postcode so the request reaches handymen who genuinely cover that part of the city.",
  areaNoteHeading: "Help a handyman judge the visit before responding",
  areaNote: "For smaller jobs, travel and setup time can matter almost as much as the task itself. Group related jobs together where possible and mention stairs, restricted parking, awkward access, heavy items or fittings that are already on site so the tradesperson can judge the visit more accurately.",
