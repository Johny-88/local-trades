...
const content: LocalCityPageContent = {
  ...
  localContextHeading: "Birmingham properties can present very different electrical jobs",
  ...
  areaIntro: "Electricians may cover different parts of Birmingham depending on workload and the type of job. Use the exact postcode whether the property is in Edgbaston, Selly Oak, Erdington, Hall Green, Yardley, Sutton Coldfield or elsewhere in the city.",
  areaNoteHeading: "Give location and fault details without investigating live equipment yourself",
  areaNote: "For fault-finding work, explain what you have observed — for example tripping, flickering, loss of power or a hot accessory — and where it is happening. Mention access, parking and whether the job is in a flat or house, but leave inspection of live electrical equipment to the electrician.",
